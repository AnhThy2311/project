...
//        String email,String hoten,String password
        ...
        try {
            ...
            String sql = "INSERT INTO Users (email, password, role_id, phone_number, full_name, date_of_birth,entity_state)  VALUES (?,?,?,?,?,?,?)";
            int trangthai = 0;
            int role = 2;
    ...
    public Customer getCustomer(String email, String password) {
        ...
        try {
            ...
            String sql = "SELECT  email, password, phone_number, full_name, date_of_birth FROM Users where email=? and password=?and entity_state=1";
            ...
            if (re.next()) {
                ...
                return new Customer(email1, password1,phone, fullName, date);
            }
        } catch (Exception e) {
