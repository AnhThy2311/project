     ...
     String userImage = (sessionUser != null && sessionUser.getAttribute("userImage") != null) 
        ...
        <div class="container mt-5">
            <div class="card shadow-lg p-4">
                ...
                <form action="EditInformation" method="post" class="needs-validation">
                    <% 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cccd" name="cccd" value="<%= (info != null) ? info.getCCCD() : "" %>" required>
                    </div>

                    <div class="mb-3">
                        <label for="issueDate" class="form-label">Issue Date</label>
                        <input type="date" class="form-control" id="issueDate" name="issueDate" value="<%= (info != null && info.getIssueDate() != null) ? sdf.format(info.getIssueDate()) : "" %>" required>
                    </div>

                    <div class="mb-3">
                        <label for="placeOfIssue" class="form-label">Place of Issue</label>
                        <input type="text" class="form-control" id="placeOfIssue" name="placeOfIssue" value="<%= (info != null) ? info.getPlaceOfIssue() : "" %>" required>
                    </div>

                    <div class="mb-3">
                        <label for="permanentAddress" class="form-label">Permanent Address</label>
                        <input type="text" class="form-control" id="permanentAddress" name="permanentAddress" value="<%= (info != null) ? info.getPermanentAddress() : "" %>" required>
                    </div>
