                    ...
                    <div class="col-md-9 col-lg-4">
                        <div class="bg-white shadow-sm rounded p-3 mb-3 d-none d-lg-block">
                            ...
                            <div class="d-flex gap-2">
                                <%
                                    Room room = (Room) request.getAttribute("room"); // Lấy đối tượng room từ request
                                %>
                                ...
                                <!-- Nút Đặt Lịch (Chỉ hiển thị nếu room tồn tại) -->
                                <div>
                                    <form action="RoomAppointmentServlet?COMMAND=CREATE_APPOINTMENT" method="post">
                                        ...
                                        <button type="submit" class="btn btn-warning text-white d-flex justify-content-center rounded-4 px-3 py-2">
                                            <i class="icon heart size-18"></i> Đặt Lịch
                                        </button>
                                    </form>                                    
                                </div>  
                            </div>
                        ...
                        <div class="g-recaptcha mt-3" data-sitekey="6LeIBEgaAAAAABhJRc5wW2KohNEXc7EKbsGncvgT" data-callback="recaptchaCallback">
                            <div style="width: 304px; height: 78px;">
                                <div><iframe 
                                        ...
                                        src="https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LeIBEgaAAAAABhJRc5wW2KohNEXc7EKbsGncvgT&co=aHR0cHM6Ly9waG9uZ3RybzEyMy5jb206NDQz&hl=vi&v=PcIQSvk4Y5ANjYUx0f4froA1&size=normal&cb=oih8q58x3o5x"
                                        allowfullscreen>
                                    </iframe>
                                </div>
