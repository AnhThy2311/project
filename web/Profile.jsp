                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            %>
                            <div class="card-body">
                                <h5 class="card-title fs-4"><strong>CCCD:</strong> <%= information.getCCCD() %></h5>
                                <p class="card-title fs-4"><strong>Issue Date:</strong> 
                                    <% 
                                        if (information.getIssueDate() != null) {
                                            SimpleDateFormat sdfOutput = new SimpleDateFormat("dd/MM/yyyy");
                                            out.print(sdfOutput.format(information.getIssueDate()));
                                        } else {
                                            out.print("N/A");
                                        }
                                    %>
                                </p>
                                <p class="card-title fs-4"><strong>Place of Issue:</strong> <%= information.getPlaceOfIssue() %></p>
                                <p class="card-title fs-4"><strong>Permanent Address:</strong> <%= information.getPermanentAddress() %></p>
                                <a href="UpdateInformation?userId=<%= customer.getEmail() %>" class="btn btn-primary">Edit Private Information</a>
                            </div>
                            <%
                                } else {
                            %>
