 ...
 * @author son
 */
@WebServlet(name="AcceptRoom", urlPatterns={"/AcceptRoom"})
public class AcceptRoom extends HttpServlet {
    ...
    throws ServletException, IOException {
       String room_id = request.getParameter("roomId");
        System.out.println("roomid là : "+room_id);
        RoomDao rd = new RoomDao();
        rd.updateStatusRoom(room_id);
        response.sendRedirect("AdminBadnewReport");
    } 
